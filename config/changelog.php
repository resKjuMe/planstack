...
return [
    'releases' => [
        [
            ...
            'changes' => [
                'Neu: Organisationen (Menüpunkt „Organisation" oben rechts). Jeder kann eine Organisation gründen oder einer bestehenden per Einladungscode beitreten; jeder gehört höchstens einer Organisation an. Die Seite zeigt Mitglieder, den Einladungscode zum Weitergeben sowie das Austreten bzw. (für Gründer) das Löschen. Der Gründer kann zudem individuelle Einladungen per E-Mail versenden (mit optionaler Team-Zuordnung) — wer sich über den persönlichen, einmaligen Link registriert, wird automatisch der Organisation und den ausgewählten Teams zugeordnet. Bereits registrierte Personen können mit dem Code aus der E-Mail über die Organisationsseite beitreten. Einen allgemeingültigen Beitrittscode gibt es nicht mehr.',
