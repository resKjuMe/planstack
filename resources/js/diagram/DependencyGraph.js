...
// CI-Rollup-Icon vor der PR-Nummer — gleiche Outline-Optik wie auf der Board-Karte:
// SUCCESS=Haken (grün), FAILURE/ERROR=Kreuz (rot), PENDING/EXPECTED=Uhr (gelb),
// sonst/null=Fragezeichen (grau). Die Farbe kommt aus CSS-Klassen (.ps-ci-*) mit
// !important (siehe app.css) — mermaid überschreibt fill/stroke der Shapes sonst
// über eigene Selektoren; ein !important-Stylesheet-Regel gewinnt zuverlässig.
const CI_ICON = {
