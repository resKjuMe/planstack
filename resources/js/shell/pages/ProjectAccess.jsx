...
// Zugriff/Mitglieder (ehemals projects/access.blade.php): zugewiesene Teams + Rollen.
export default function ProjectAccess({ project, editTabs, canManage, teams, assignableTeams, users, roles, urls, strings }) {
