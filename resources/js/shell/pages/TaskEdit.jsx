            ...
            <div className="py-8">
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <Deferred data="formData" fallback={<FormSkeleton rows={9} />}>
                        <EditBody showReview={showReview} updateUrl={updateUrl} destroyUrl={destroyUrl} showUrl={showUrl} strings={strings} />
                    </Deferred>
                </div>
            </div>
        </>
...
function EditBody({ showReview, updateUrl, destroyUrl, showUrl, strings }) {
