...
// Projekt-Einstellungen „Allgemein" (ehemals projects/edit.blade.php).
export default function ProjectEdit({ project, editTabs, canDelete, updateUrl, destroyUrl, strings }) {
    const form = useForm({
        alias: project.alias,
        name: project.name,
