...
// Phasen-Verwaltung (ehemals projects/phases.blade.php): anlegen, umbenennen,
// umsortieren, löschen.
export default function ProjectPhases({ project, editTabs, canContribute, phases, urls, strings }) {
