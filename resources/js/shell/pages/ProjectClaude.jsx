...
export default function ProjectClaude({
    configVersion, profile: initialProfile, presets, defaults, hintKeys, meta, values: initialValues, costs,
    groups, profilePills, skillText, editTabs, updateUrl, cancelUrl, flash, strings,
}) {
    const form = useForm({
