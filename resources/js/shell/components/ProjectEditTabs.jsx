...
// Server-gerenderte Tabs (key/label/href/active); die Links sind gewöhnliche <a>
// und werden vom globalen Interceptor reload-frei über Inertia geführt.
export default function ProjectEditTabs({ tabs }) {
    return (
