...
export default function ExceptionLane({ t, tasks, renderCard, onCollapse }) {
    ...
    return (
        <div className="board-cell flex h-full w-full min-w-0 flex-col rounded-lg bg-rose-50/60 dark:bg-rose-900/15 p-2 ring-1 ring-rose-100 dark:ring-rose-900/40">
