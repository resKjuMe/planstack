...
<div class="flex items-center gap-2">
    @can('update', $project)
        <form method="POST" action="{{ route('projects.sync-prs', $project) }}"
              onsubmit="return confirm('{{ __('components.fetch_the_merge_status_of_all_open_prs') }}');">
            @csrf
            <button class="inline-flex items-center gap-1.5 rounded-md bg-white dark:bg-gray-800 px-3 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 ring-1 ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50">
        ...
        <a href="{{ route('projects.edit', $project) }}"
           class="inline-flex items-center gap-1.5 rounded-md bg-white dark:bg-gray-800 px-3 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 ring-1 ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50">
            <svg class="h-4 w-4 text-gray-500 dark:text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
