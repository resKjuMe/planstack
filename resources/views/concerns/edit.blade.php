                ...
                <form method="POST" action="{{ route('projects.tasks.concern.update', [$project, $task]) }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="description_context" name="description_context" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm">{{ old('description_context', $c?->description_context) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description_blocker" name="description_blocker" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm">{{ old('description_blocker', $c?->description_blocker) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description_misconception" name="description_misconception" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm">{{ old('description_misconception', $c?->description_misconception) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description_decisions" name="description_decisions" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm font-mono text-sm">{{ old('description_decisions', $c?->description_decisions) }}</textarea>
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">{{ __('concerns.1_decision_per_line_options_as_csv_with') }} <code>{{ __('concerns.which_way_to_go_option_a_option_b') }}</code></p>
                    </div>
