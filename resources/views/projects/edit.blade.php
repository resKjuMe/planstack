        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('projects.update', $project) }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400">{{ __('projects.format') }} <span class="font-mono">owner/repo</span> {{ __('projects.for_pr_linking_and_the_sync_prs_button') }}</p>
                    ...
                    <div class="border-t border-gray-100 pt-5 space-y-4">
                        <label for="completed" class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">
                                ...
                                <span class="block text-xs text-gray-400">{{ __('projects.shows_the_completed_badge_in_the') }}</span>
                            </span>
                        </label>
                        ...
                        <label for="archived" class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">
                                ...
                                <span class="block text-xs text-gray-400">{{ __('projects.hides_the_project_from_the_project_list') }}</span>
                            </span>
                        </label>
                    </div>
            ...
            @can('delete', $project)
                <div class="bg-white rounded-lg shadow p-6 border border-red-100">
                    <h3 class="font-semibold text-red-700">{{ __('projects.delete_project') }}</h3>
                    <p class="text-sm text-gray-500 mt-1">{{ __('projects.removes_the_project_including_all_tasks') }}</p>
