...
<section class="bg-white rounded-lg shadow p-6">
    <h3 class="font-semibold text-gray-900 mb-3">IST/SOLL-Vergleich</h3>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                <div class="mb-2 flex items-center gap-2 text-sm font-semibold text-gray-500">
                    ...
                    IST <span class="font-normal text-gray-400">(vorher)</span>
                </div>
            ...
            <div class="rounded-lg border border-green-200 bg-green-50 p-4">
                <div class="mb-2 flex items-center gap-2 text-sm font-semibold text-green-700">
                    ...
                    SOLL <span class="font-normal text-green-600/70">(nachher)</span>
                </div>
                <div class="text-sm text-gray-800">
