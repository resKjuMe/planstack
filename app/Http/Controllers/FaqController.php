...
class FaqController extends Controller
{
    ...
    public function commands(): InertiaResponse
    {
        ...
        $lifecycle = [
            ...
            ['GET /projects/{p}/tasks/{t}?fields=full', 'lc_details', null, null],
            ['POST …/tasks/{t}/status {analyze}', 'lc_analyze', 'ANALYZING', '⚙ Auto (Pick) DCE · C27 — Analyse'],
            ['POST …/tasks/{t}/status {in_progress}', 'lc_in_progress', 'IN_PROGRESS', '⚙ Auto (Pick) DCE · C27 — Umsetzung'],
            ['POST …/tasks/{t}/concern', 'lc_concern', 'CONCERNED', '⚙ Auto (Concern) DCE · C27 — Concern gemeldet'],
            ['gh pr create', 'lc_pr_create', null, '⚙ Auto (Pick) DCE · C27 — PR erstellen'],
            ['POST …/tasks/{t}/pr {pr_number}', 'lc_pr_set', null, '⚙ Auto (Pick) DCE · C27 — PR #418'],
            ['POST …/tasks/{t}/status {done}', 'lc_done', 'IN_REVIEW', '⚙ Auto (Finish) DCE · C27 — fertig gemeldet'],
            ['POST …/tasks/{t}/review-claim', 'lc_review_claim', null, '⚙ Auto (Review) DCE · A1 — Diff prüfen'],
            ['POST …/tasks/{t}/review {recommendation,summary}', 'lc_review_result', null, '⚙ Auto (Review) DCE · A1 — Ergebnis erfassen'],
