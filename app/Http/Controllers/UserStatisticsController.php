    ...
    private function strings(): array
    {
        return [
            ...
            'helpBullets' => [
                ...
                ['strong' => __('statistics.help_weekly'), 'text' => __('statistics.help_weekly_text')],
            ...
            'weeklyTipReviewed' => __('statistics.weekly_tip_reviewed'),
            ...
            'durationsMedianTask' => __('statistics.durations_median_task'),
            ...
            'mRework' => __('statistics.m_rework'),
            'mReworkMultiple' => __('statistics.m_rework_multiple'),
            'mRequestChanges' => __('statistics.m_request_changes'),
            'neverSynced' => __('statistics.never_synced'),
            'criticalityUnset' => __('statistics.criticality_unset'),
            'criticalityKnown' => __('statistics.criticality_known'),
